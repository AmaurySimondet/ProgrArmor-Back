...
passport.use(new GoogleStrategy({
    ...
    async (accessToken, refreshToken, profile, done) => {
        ...
        console.log("callback URL: " + url + "/user/auth/google/authenticate");
...
async function signup(req, res) {
    ...
    User.register(
        { fName: req.body.fName, email: req.body.email, lName: req.body.lName, normalizedName: normalizedName, language: req.body.language },
        req.body.password,
        function (err, user) {
            if (err) {
                console.log(err)
