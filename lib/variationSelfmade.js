...
function buildSelfmadeCreatePayload(raw = {}) {
    ...
    const requestedDefaultMode = String(raw.defaultMode || 'repetitions').trim();
    const normalizedDefaultMode = DEFAULT_MODES.includes(requestedDefaultMode)
    ...
    const payload = {
        ...
        selfmade: true,
        verified: false,
        defaultMode: isExercice ? normalizedDefaultMode : 'repetitions',
