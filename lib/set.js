...
const { search: { SEARCH_MAX_TIME_MS }, set: { PR_CATEGORIES } } = require('../constants');
 ...
 */
async function getSets(userId, excludedSeanceId, seanceId, exercice, categories, unit, value, weightLoad, elasticTension, dateMin, dateMax, fields, variations, unilateralSide) {
    try {
        const query = {};
        if (userId) {
...
async function fetchSetsForPR(userId, excludedSeanceId, exercice, categories, dateMin, variations, unilateralSide) {
...
async function getPRs(userId, excludedSeanceId, exercice, categories, dateMin, variations, unilateralSide) {
    try {
        const sets = await fetchSetsForPR(userId, excludedSeanceId, exercice, categories, dateMin, variations, unilateralSide);
...
async function getDetailedPRs(userId, exercice, categories, dateMin, variations, unilateralSide) {
    try {
        ...
        const sets = await fetchSetsForPR(userId, null, exercice, categories, dateMin, variations, unilateralSide);
