...
async function evaluatePersonalRecordWithContext(
    ...
    try {
        logPrEval('request', {
            ...
            historicalBeforeDate: historicalBeforeDate != null ? String(historicalBeforeDate) : null,
            prReferenceDate: Number.isNaN(prReferenceDate.getTime()) ? null : prReferenceDate.toISOString(),
        });
        ...
        logPrEval('athCompare', {
            ...
            isAth,
            setsAtSameLoadCount: setsAtSameLoad.length,
            setsAtSameValueCount: setsAtSameValue.length,
            maxValueAtSameLoad,
            maxLoadAtSameValue: maxLoadAtSameValue != null ? round2(maxLoadAtSameValue) : null,
            hasHistoryAtLoad,
            hasHistoryAtValue,
        ...
        logPrEval('result', {
            status,
            statusReason,
            maxValueAtSameLoad: maxValueAtSameLoad != null ? maxValueAtSameLoad : null,
            maxLoadAtSameValueKg: maxLoadAtSameValue != null ? round2(maxLoadAtSameValue) : null,
            setsAtSameLoadCount: setsAtSameLoad.length,
            setsAtSameValueCount: setsAtSameValue.length,
        });
