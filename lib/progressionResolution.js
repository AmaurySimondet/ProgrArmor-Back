...
function resolveLateralModeForRecommendation(lateralMode = 'bilateral', unilateralSide = undefined) {
    const normalizedMode = normalizeLateralMode(lateralMode);
    if (normalizedMode === 'left' || normalizedMode === 'right') {
        return normalizedMode;
    }
    if (unilateralSide === 'left' || unilateralSide === 'right') {
        return unilateralSide;
    }
    return 'bilateral';
}
