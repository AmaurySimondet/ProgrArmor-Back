...
/**
 * Delete a seance by id, also deletes the sets and photos associated with the seance
 * @param {string} id - The ID of the seance.
 * @param {string} user - The ID of the user.
 * @returns {Promise<void>} - A promise that resolves when the seance, associated sets, and photos are deleted.
 */
