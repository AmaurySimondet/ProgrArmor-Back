...
async function userStats(req, res) {
    try {
        ...
        const [
            ...
            // Calculate total volume, handle "repetitions" by multiplying weightLoad * value, else just sum weightLoad
            SeanceSet.aggregate([
                { $match: { user: userIdObj } },
                {
                    $group: {
...
module.exports = { modifyUser, getUser, getUsers, searchUsers, userStats, followUser, unfollowUser, getRegularityScore, updateLanguage, getTopUsers };