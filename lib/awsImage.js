 ...
 */
async function recordUploadedImage(userId, uploadResult, seanceDate = null, seanceName = null, programId = null) {
 ...
 * @returns {Promise<Object>} - A promise that resolves to the recorded image object
 */
async function recordSeancePhotoUpload(userId, uploadResult, seanceDate, seanceName, programId = null) {
    console.log("Uploading seance photo for user:", userId, "with seance date:", seanceDate, "and seance name:", seanceName, "programId:", programId, "with upload result:", uploadResult);
    const savedImage = await recordUploadedImage(userId, uploadResult, seanceDate, seanceName, programId);
...
async function recordUpload(userId, uploadResult, options = {}) {
    const { isProfilePic = false, seanceDate = null, seanceName = null, programId = null } = options;
    ...
    return recordSeancePhotoUpload(userId, uploadResult, seanceDate, resolvedSeanceName, resolvedProgramId);
}
