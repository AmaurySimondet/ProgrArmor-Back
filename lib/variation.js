...
function buildWorkoutSuggestionsOrderedList(tier1Items, tier2Items, tier3Items) {
    ...
    return [...leadingTier1, ...tier2Items, ...tier3Items, ...trailingTier1];
}
...
async function getWorkoutDetailSuggestions({
    ...
    const exclusionStateIdsOnly = buildWorkoutDetailExclusionState(allTier1Items, { includeComboSignatures: false });
    ...
    const tier1ItemsRaw = dropPerformedCoveredByCatalogCombos(
        allTier1Items.slice(0, WORKOUT_DETAIL_TIER1_MAX),
